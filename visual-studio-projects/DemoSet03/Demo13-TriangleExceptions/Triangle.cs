...
namespace ConceptArchitect.Shapes
{
    public class Triangle
    {
        ...
        private void Validate()
        {
            ...
            if (!Valid)
                throw new ShapeException("Invalid Shape: Sum of two sides of Triangle should be greater than the third");
        ...
        public double this[int side]
        {
            get
            {
                if (side < 1 || side > 3)  //invalid triangle side
                    throw new ShapeException($"Invalid Side Requested {side}. Valid values should be between 1-3");
